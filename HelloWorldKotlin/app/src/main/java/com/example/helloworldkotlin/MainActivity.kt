...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*var timesClicked = 0
        bomButton.setOnClickListener {
            timesClicked++
            txtHelloWorld.text = timesClicked.toString()
        ...
        bomButton.setOnClickListener { holdArrays(1) }
        kjvBibleButton.setOnClickListener { holdArrays(2) }
        quranButton.setOnClickListener { holdArrays(3) }
